...
class Configuration:
    ...
    # Custom metrics
    METRIC_CACHE_HIT_ADVISER_AUTHENTICATED = 0
    METRIC_CACHE_HIT_ADVISER_UNHAUTHENTICATED = 0
    METRIC_CACHE_HIT_PROVENANCE_CHECKER_AUTHENTICATED = 0
    METRIC_CACHE_HIT_PROVENANCE_CHECKER_UNHAUTHENTICATED = 0
